...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_MISRA_STATICINLINECHECK_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_MISRA_STATICINLINECHECK_H
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_MISRA_STATICINLINECHECK_H
