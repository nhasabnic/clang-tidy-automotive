...
public:
  void addCheckFactories(ClangTidyCheckFactories &CheckFactories) override {
    ...
    /* 2.4 */
    /* 2.5 */
    CheckFactories.registerCheck<UnusedlabelCheck>(
        "misra-c2023-adv-2.6");
    ...
    CheckFactories.registerCheck<StaticInlineCheck>(
        "misra-c2023-req-8.10");
    /* 8.11 m varDecl(allOf(hasType(arrayType(incompleteArrayType())), hasExternalFormalLinkage())) */
    ...
    CheckFactories.registerCheck<MissingCompoundCheck>(
        "misra-c2023-req-15.6");
    CheckFactories.registerCheck<MissingElseCheck>(
        "misra-c2023-req-15.7");

    /* 16. Switch Statements */
    /* ------------------------------------------------------------- */
    CheckFactories.registerCheck<UnstructuredcaseCheck>(
        "misra-c2023-req-16.2");
    ...
    CheckFactories.registerCheck<WrongorderdefaultinswitchstatementCheck>(
     ...
     /* 16.2 Inspiration: m caseStmt(unless(hasParent(compoundStmt(hasParent(switchStmt()))))) */
   ...
   CheckFactories.registerCheck<misc::NoRecursionCheck>(
    ...
    CheckFactories.registerCheck<NoreturnvoidCheck>(
        "misra-c2023-req-17.10");
    /* 18. Pointers and arrays */
    /* ------------------------------------------------------------- */
    /* 18.7 m Inspiration:  varDecl(allOf(hasType(arrayType(incompleteArrayType()))))
       18.8 m Inspiration:  varDecl(allOf(hasType(arrayType(incompleteArrayType()))))
*/

    /* 19. Overlapping Storage */
    /* ------------------------------------------------------------- */
    CheckFactories.registerCheck<AvoidUnionCheck>(
        "misra-c2023-adv-19.2");

    /* 20. Preprocessing directives */
    /* ------------------------------------------------------------- */
    /* 20.3 clang-native: clang-diagnostic-error */
    CheckFactories.registerCheck<AvoidUndefCheck>(
        "misra-c2023-adv-20.5");
    ...
    CheckFactories.registerCheck<AtoXCheck>(
        "misra-c2023-req-21.7");
    CheckFactories.registerCheck<ExitCheck>(
        "misra-c2023-req-21.8");
...
public:
  void addCheckFactories(ClangTidyCheckFactories &CheckFactories) override {
    CheckFactories.registerCheck<AvoidGotoCheck>(
        "misra-c2012-adv-15.1");
    CheckFactories.registerCheck<MissingCompoundCheck>(
        "misra-c2012-req-15.6");
  }
};
